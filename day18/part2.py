...
pattern = re.compile(r'[UDRL] \d+ \(#([A-Fa-f0-9]{5})(\d{1})\)')
...
def processLine(line):
    ...
    if m: 
        return (DIRECTIONS[int(m[2])], int(m[1], 16))
...
calculateCubicMeters(sampleFilename) # 952408144115
calculateCubicMeters(inputFilename) # 42617947302920